...
export function MainScreen({ navigation }) {
    ...
    return (isMobile()) ? (
        ...
        <div className="App">
            <html data-theme="nord"></html>
            <Header navigation={navigation} useSignOut={true} setName={nameString} />
            <div id="overall-row" class="flex flex-row ml-10">
                <div id="graph-table-holder" class="flex-col basis-2/3 pl-0">
                    <div id="graph-top" class="flex-none self-stretch basis-1/2 pl-0">
                        <div class="flex flex-row pl-0">
                            <div class="flex-volu basis-1/2 pl-0">
                                <h1 className="ml-10" style={{ fontSize: "2rem", fontWeight: "bold" }}>{name} </h1>
                                <h6 className="ml-10" style={{ fontSize: "3rem", fontWeight: "400" }}>$8.20</h6>
